...
{
    m_texture = &texture;
    m_quads[0] =-m_texture->getWidth()/2;  m_quads[1] =-m_texture->getWidth()/2;
    m_quads[2] = m_texture->getWidth()/2;  m_quads[3] =-m_texture->getWidth()/2;
    m_quads[4] = m_texture->getWidth()/2;  m_quads[5] = m_texture->getWidth()/2;
    m_quads[6] =-m_texture->getWidth()/2;  m_quads[7] = m_texture->getWidth()/2;
}
